...
class Bill_App:
    ...
    # =======================ButtonFrame=============
        ...
        discount_lbl = Label(F6, text="Discount (%)", font=('times new roman', 14, 'bold'), bg="#badc57", fg="black")
        discount_lbl.grid(row=0, column=4, padx=20, pady=1, sticky='W')
        discount_txt = Entry(F6, width=18, textvariable=self.discount, font='arial 10 bold', bd=7, relief=GROOVE)
        discount_txt.grid(row=0, column=5, padx=18, pady=1)
        

    # =======Buttons-======================================
        btn_f = Frame(F6, bd=7, relief=GROOVE)
        btn_f.place(x=760,y=30, width=580, height=105)
...
#================totalBill==========================
    def total(self):
        ...
        self.c_d_tax = round((self.total_cold_drinks_price * 0.01), 2)
        ...
        discount_percent = self.discount.get()

        discount_amount = (self.total_bill * discount_percent) / 100

        self.final_bill = self.total_bill - discount_amount
...
#=========billArea=================================================
    ...
    # ==============Grocery============================
        ...
        self.txtarea.insert(END, f"\n Final Amount:\t\t Rs.{round(self.final_bill,2)}")
        self.txtarea.insert(END, f"\n--------------------------------")
        self.save_bill()
